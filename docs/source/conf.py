...
html_title = "rstcloth: A python API for generating RestructuredText"
...
latex_documents = [
    ("index", "rstcloth.tex", "rstcloth", "Thomas Clark", "manual"),
]
...
man_pages = [("index", "rstcloth", "rstcloth", ["Thomas Clark"], 1)]
...
texinfo_documents = [
    (
        ...
        "Thomas Clark",
        "rstcloth",
        "A python API for generating RestructuredText",
        "Miscellaneous",
    ),
]
